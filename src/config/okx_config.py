...
class OKXConfig:
    ...
    def _setup_paths(self) -> None:
        ...
        if not os.path.isabs(self.config['data_directory']):
            self.config['data_directory'] = str(project_root / self.config['data_directory'])
        
        if not os.path.isabs(self.config['crypto_list_file']):
            self.config['crypto_list_file'] = str(project_root / self.config['crypto_list_file'])
